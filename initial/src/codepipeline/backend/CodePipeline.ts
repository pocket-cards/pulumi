...
export default (codebuild: Initialize.CodePipeline.BackendCodeBuildOutputs) => {
  // create pipeline
  const pipeline = createPipeline(codebuild);
...
/** Create CodePipeline */
const createPipeline = (codebuild: Initialize.CodePipeline.BackendCodeBuildOutputs) => {
